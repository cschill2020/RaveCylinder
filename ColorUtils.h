...
void fill_gradient(T *targetArray, uint16_t startpos, CHSV startcolor,
  ...
  uint16_t sat88 = startcolor.saturation << 8;
  uint16_t val88 = startcolor.value << 8;
...
typedef TDynamicRGBGradientPalette_bytes
    TDynamicRGBGradientPalettePtr; ///< Alias of
...
public:
  ...
  /// Creates a palette from a gradient palette.
  ///
...
public:
  ...
  CHSVPalette32(const TProgmemHSVPalette32 &rhs) {
    for (uint8_t i = 0; i < 32; ++i) {
      ...
      entries[i].saturation = xyz.green;
      entries[i].value = xyz.blue;
    }
  }
  /// @copydoc CHSVPalette16::CHSVPalette16(const TProgmemHSVPalette16&)
...
public:
  ...
  /// @copydoc CRGBPalette16::CRGBPalette16(TProgmemRGBGradientPalette_bytes)
  CRGBPalette256(TProgmemRGBGradientPalette_bytes progpal) { *this = progpal; }
